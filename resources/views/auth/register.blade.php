                ...
                <div class="col-lg-4 col-md-5 col-12">
                    ...
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                ...
                                <div class="col-12 text-center">
                                  <button type="submit" class="btn btn-info btn-rounded margin-top-10">  {{ __('Register') }}</button>
                        ...
                        <div class="text-center">
                            <p class="mt-15 mb-0 text-black">Already have an account?<a href="/login" class="text-danger ml-5"> Sign In</a></p>
                        </div>
                    </div>
                </div>
            </div>
