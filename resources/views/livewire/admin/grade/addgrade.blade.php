                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    @foreach ($grades as $index => $grade)
                                                        <input type="text"  class="form-control"  placeholder="@lang('site.add new grade')">
                                                    @endforeach
                                                 </div>
                                                 <input type="text"  wire:model="newgrade" class="form-control" placeholder="@lang('site.add new grade')">
                                            </div>
