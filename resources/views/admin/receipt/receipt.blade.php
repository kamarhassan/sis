        ...
        <div class="row invoice-info">
            <div class="col-md-6 invoice-col">
                ...
                <address>
                    ...
                    <br>@lang('site.registration id') : {{ $std['id'] }}<br>
                    <br>@lang('site.registration date') : {{ $std['created_at']->format('d-m-Y') }}<br>
            ...
            <div class="col-md-6 invoice-col">
                ...
                @isset($cours['institue_information_id'])
                    ...
                    <address>
                        ...
                        <strong class="d-inline">{{ $cours['institue_information'][0]['name'] }} </strong><br>
                        <strong class="fa fa-phone">{{ $cours['institue_information'][0]['phone'] }} </strong><br>
                        <strong class="mdi mdi-email"> {{ $cours['institue_information'][0]['email'] }}</strong><br>
                        <strong class="fa fa-building-o"> {{ $cours['institue_information'][0]['building'] }} </strong>
                    </address>
                @endisset
            </div>
            ...
            <div class="table-responsive">
                <table id="payment_table" class="table table-hover mb-0 border">
                    <tr>
                        <td>@lang('site.receipt id') # {{ $receipt->id }}</td>
                        <td>@lang('site.user ID') : {{ $std['user_id'] }}</td>

                        <td>
                           @lang('site.cours') : {{ $cours['category_grade_level']['name'] }} #
                            {{ $std['cours_id'] }}</span>
                            <br>
                            ...
                            <td>
                              @lang('site.amount'): {{ $receipt->amount_total }} <span class="text-warning">
                                    {{ $currency['symbol'] }} - {{ $currency['abbr'] }}</span>
                                 </td>
            ...
            {{--               <div class="col-md-6 col-lg-3"><b>@lang('site.receipr id') # {{ $receipt->id }}</b></div> --}}

            {{--               <div class="col-md-6 col-lg-3"><b>@lang('site.user ID') : {{ $std['user_id'] }}</b></div> --}}
            {{--               <div class="col-md-6 col-lg-3"><b><span>@lang('site.cours') : --}}
            {{--                                {{ $cours['category_grade_level']['name'] }} # {{ $std['cours_id'] }}</span> --}}
            {{--                     <br> --}}
            {{--                     {{ $cours['category_grade_level']['grade']['grade'] }} , --}}
            {{--                     {{ $cours['category_grade_level']['level']['level'] }}</b> --}}

            {{--               </div> --}}
            {{--               <div class="col-md-6 col-lg-3"><b>@lang('site.amount'): {{ $receipt->amount_total }} <span --}}
            {{--                        class="text-warning"> {{ $currency['symbol'] }} - {{ $currency['abbr'] }}</span></b> --}}
            {{--               </div> --}}
            {{--            </div> --}}
            {{--         </div> --}}
                    ...
                    <div class="table-responsive">
                        <table id="payment_table" class="table table-hover mb-0">
                            ...
                            <tr scope="col" class="text-warning text-uppercase">
                                ...
                                <td scope="row"> {{ $std['cours_fee_total'] - $std['remaining'] }} </td>
