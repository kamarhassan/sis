                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body card-dashboard">
                            ...
                            <form id='edit_registartion_form'>
                                @csrf
                                <input type="hidden" name="std_registartion_id"
                                    @isset($std_registartion) value="{{ $std_registartion['id'] }}"@endisset>
                                <input type="hidden" name="teach_type"
                                    value="@isset($teach_type['key']) {{ $teach_type['key'] }}@endisset">
                                <div class=" box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 bb-1 border-success">
                                            <span>
                                                @lang('site.registration date') : <span class=" ">{{ date('Y-m-d') }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                           ...
                           @endisset>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <textarea name="textarea" id="textarea" class="form-control" placeholder="@lang('site.note write')" aria-invalid="false"> </textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="col-md-3">
                                        <a class="btn  glyphicon glyphicon-arrow-left hover-success"
                                            ...
                                            onclick="Issponsored('fee_no_discount','fee_with_discount'),submit('{{ route('admin.post-std-edit-registration') }}','edit_registartion_form');">
