...
@section('title')
@lang('site.certificate template')
@endsection
@section('css')
                            ...
                            <div class="card-body card-dashboard">
                                <p class="card-text">
                                    @can('create certificate')
                                        <a href="{{route('admin.certificate.templates.create')}}" class="btn fa fa-plus"> @lang('site.add new templates')</a>
                                    @endcan
                                </p>
                                    ...
                                    <tbody>
                                        @isset($certificate)
                                            @foreach ($certificate as $certificate_)
                                                <tr id="Row{{ $certificate_['id'] }}"  class="mb-10 p-10 cursor_pointer hover-success">
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('edit certificate')
                                                            <a href="{{ route('admin.certificate.templates.edit', $certificate_['id']) }}"
                                                                class="btn text-warning   hover-danger fa fa-edit" title="@lang('site.edit')">
                                                            </a>
                                                        @endcan
                                                        @can('delete certificate')
                                                            <a title="@lang('site.delete')"
                                                                class="btn text-danger fa fa-trash-o hover-danger"
                                                                onclick="delete_by_id('{{ route('admin.certificate.templates.delete') }}',{{ $certificate_['id'] }},'{{ csrf_token() }}','{{ json_encode(swal_fire_msg()) }}');">
                                                            </a>
                                                        @endcan
                                                    </td>
                                                </tr>
