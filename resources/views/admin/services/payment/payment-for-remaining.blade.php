...
@section('title')
@lang('site.payment for remaining')
@endsection
@section('css')
@endsection
@section('content')
                ...
                <div class="box ">
                    <div class="row show-grid">
                        ...
                        <div class="col-md-6" id="normal_pament">
                            <input type="number" id="amount_to_paid" step="any" class='form-control' value="0"
                        ...
                        <div class="col-md-6" id="Other_payment" hidden>
                            ...
                            <div class="col-md-6" id="normal_pament">
                                ...
                                <input type="number" id="rate" step="any" class='form-control'
                                    placeholder="@lang('site.rate')" name="rate" value="">
                            ...
                            <div class="col-md-6" id="normal_pament">
                                <div class="form-group">
                                    ...
                                    <select name="other_payment_currency" class="form-control select2" style="width: 100%;">
                                        @foreach ($service_currency as $service_currencys)
            ...
            <div class="row">
                <div class="col-md-3">
                    <button class="btn  glyphicon glyphicon-arrow-left hover-success " title="@lang('site.save')"
                        type="submit" onclick="savepayment('{{ route('admin.payment.payment_client_remaining_to_receipt') }}');">
