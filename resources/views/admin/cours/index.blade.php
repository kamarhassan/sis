                    ...
                    <tbody>
                        @isset($cours)
                            @foreach ($cours as $key => $cour)
                                <tr id="Row{{ $cour->id }}" class="hover-success hoverable">
                                    <td> {{ $cour['id'] }}</td>
                                    <td>{{ $cour['category_name'] }} [ {{ $cour['grade'] }}, {{ $cour['level'] }} ]</td>
                                    <td> {{ $cour['status'] }}</td>
                                    <td> {{ $cour['teacher'] }} </td>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            @endcan
                                            @can('info cours')
                                                <a class="btn  glyphicon glyphicon-info-sign hover-danger"
                                                    title="@lang('site.info')"
                                                    onclick="to('{{ route('admin.cours.info', $cour->id) }}')">
                                                </a>
                                            @endcan
                                        </div>
                                    </td>
