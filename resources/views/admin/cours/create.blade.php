                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form"> @lang('site.add new class') </h4>
                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                        </div>
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form id="cours_create">
                                    @csrf
                                    <div class="form-body">
                                    ...
                                    <div class="form-actions">
                                        <div class="form-actions">
                                            ...
                                            <a onclick="submit('{{ route('admin.cours.store') }}' ,'cours_create');"
