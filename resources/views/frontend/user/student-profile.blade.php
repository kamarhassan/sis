            ...
            <div class="box">
                ...
                <form class="form" id="user_profile">
                    ...
                    <div class="box-body">
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>@lang('site.segel')<span class="text-danger">*</span></label>
                              <input type="text" id="segel" name="segel" class="form-control"
                                  placeholder="@lang('site.segel')"
                                  value="@isset($user['segel']) {{ $user['segel'] }} @endisset">
                              <span class="text-danger" id="segel_"> </span>
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>@lang('site.segel')<span class="text-danger">*</span></label>
                              <select type="text" id="segel_place" name="segel_place"
                                  class="selectize-multiple"
                                  value="@isset($user['segel_place']) {{ $user['segel_place'] }} @endisset">
                                  <option value="">----------------</option>
                              </select>
                              <span class="text-danger" id="segel_place_"> </span>
                          </div>
                      </div>
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>@lang('site.gender')<span class="text-danger">*</span></label>
                              <select type="gender" id="gender" name="gender" class="selectize-multiple">
                                  <option value="">----------------</option>
                              </select>
                              <span class="text-danger" id="gender_"> </span>
                          </div>
                      </div>
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <select id="nationality" name="nationality" class="selectize-multiple">
                                  <option value="">----------------</option>
                              </select>
                              <span class="text-danger" id="nationality_"> </span>
                          </div>
                      </div>
                  </div> --}}
                    ...
                    <div class="box-footer">
                        ...
                        <a onclick="submit('{{ route('web.post.student.profile') }}' ,'user_profile');" type="submit"
