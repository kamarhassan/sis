                                        ...
                                        <form class="form">
                                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>@lang('site.First Name')<span
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>@lang('site.Middle Name')<span class="text-danger">*</span>
                                                            </label>
                                                            <input type="text" class="form-control"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>@lang('site.Last Name')<span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>@lang('site.BirthDay place')<span
                                                                    class="text-danger">*</span></label>
                                                            <select class="form-control" placeholder=@lang('site.BirthDay place')>
