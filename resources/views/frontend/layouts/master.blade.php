...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ URL::asset('assets/frontend/img/favicon.pn') }}" rel="icon">
    <link href="{{ URL::asset('assets/frontend/img/apple-touch-icon.pn') }}" rel="apple-touch-icon">
    ...
    <link href="{{ URL::asset('assets/frontend/vendor/bootstrap/css/bootstrap.rtl.min.css') }}" rel="stylesheet">
