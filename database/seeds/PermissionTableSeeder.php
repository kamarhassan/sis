...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['guard_name' => 'admin', 'tab_name' => 'setting', 'parent' => 'language', 'name' => 'language']);
        ...
        Permission::create(['guard_name' => 'admin', 'tab_name' => 'cours', 'parent' => 'edit delet cours', 'name' => 'edit cours']);
        Permission::create(['guard_name' => 'admin', 'tab_name' => 'cours', 'parent' => 'edit delet cours', 'name' => 'delete cours']);
        ...
        Permission::create(['guard_name' => 'admin', 'tab_name' => 'students', 'parent' => 'register order students', 'name' => 'register order']);
        ...
        Admin::find(27)->assignRole('super admin');
        // Admin::create([
        //     'name' => 'Hassan Kamar',
        ...
        // $role = Role::create(['guard_name' => 'admin','tab_name'=>'', 'name' => 'teacher']);
