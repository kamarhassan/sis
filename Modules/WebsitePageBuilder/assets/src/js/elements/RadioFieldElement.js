class RadioFieldElement extends SuperElement {
    constructor(obj) {
        super(obj);
    ...
    getControls() {
        ...
        return [
            ...
            new FieldOptionsControl(getI18n('options'), {
                options: element.obj.find('.radio-option').map(function() {
                    return {
                ...
                options.options.forEach(function(option) {
                    element.obj.find('.inputs-group').append(`
                        <span class="mr-4 radio-option">
                            <input type="radio" name="`+fname+`" value="`+option.value+`" autocomplete="off">
