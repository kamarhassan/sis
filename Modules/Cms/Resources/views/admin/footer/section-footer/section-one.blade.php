   ...
   <div class="col-lg-3 mt-30 ">
      <div class="col-lg-12">
         ...
         <form method="POST" action="" accept-charset="UTF-8" 
               class="form-horizontal" enctype="multipart/form-data" id="update_footer_section_one_title">
            ...
            <input type="hidden" name="key" value="footer_section_one_title">
               ...
               <div class="add-visitor">
                  ...
                  <div class="tab-content pt-3">
                     <input type="text" name="setting_value" class="form-control" value="{{$footer['footersectionsetting'][1]['value']}}">
                  </div>
                  <div class="row mt-40">

                     <div class="col-lg-12 text-center tooltip-wrapper"
                          data-title="" data-original-title="" title="">
                        <a  onclick="submit_rediret('{{ route('footerSetting.footer.content-update') }}','update_footer_section_one_title')" class="btn btn-rounded btn-primary float-right" data-original-title="" title=""><i
   ...
   <div class="col-lg-9 mt-50">
      @if (true)
         ...
         <a type="button" class="btn btn-rounded btn-default  hover-success" data-toggle="modal"
            data-target="#modal-center" onclick="edit_category(1);">
   ...
   <div class="QA_section QA_section_heading_custom check_box_table">
      <div class="QA_table">
         ...
         <div class="table-responsive">
            <table id="section-one" class="table table-hover">
               <thead>
               <tr>
                  <th scope="col">{{ __('site.SL') }}</th>
               ...
               @foreach ( $SectionOnePages  as $key => $page)
                  <tr id="Row{{$page->id}}">
                     ...
                     <td>
                        ...
                        @else
                           {{ $page->status == 1 ? trans('site.Active') : trans('site.Inactive') }}
                        @endif
                     </td>
