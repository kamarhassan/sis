<div class="row">
   <div class="col-lg-3 mt-30">
      <div class="col-lg-12">
         ...
         <form method="POST" action="" accept-charset="UTF-8"
               class="form-horizontal" enctype="multipart/form-data" id="footer_section_three_title">
            ...
            <div class="bg-gradient-warning">
               ...
               <div class="add-visitor">
                  ...
                  <div class="tab-content pt-3">
                     <input type="text" name="setting_value" class="form-control" value="{{$footer['footersectionsetting'][3]['value']}}">
                  ...
                  <div class="row mt-40">
                     ...
                     <div class="col-lg-12 text-center tooltip-wrapper"
                        ...
                        <a  onclick="submit_rediret('{{ route('footerSetting.footer.content-update') }}','footer_section_three_title')" class="btn btn-rounded btn-primary float-right" data-original-title="" title=""><i
   ...
   <div class="col-lg-9 mt-50">
      @if (true/*permissionCheck('footerSetting.footer.widget-store')*/)


         <div class="row" class="">

         <a type="button" class="btn btn-rounded btn-default  hover-success" data-toggle="modal"
                 data-target="#modal-center"  onclick="edit_category(3);">
   ...
   <div class="QA_section QA_section_heading_custom check_box_table">
      <div class="QA_table">
         ...
         <div class="table-responsive">
            <table id="section-three" class="table table-hover">
               <thead>
               <tr>
