...
//          return $request;  
         ...
         // return $t;
         $service = Service::find(decrypt($request->service_id));

         ($request->quantity == null) ? $new_quantite = $service->quantity - $request->quantity : $new_quantite = $service->quantity = 1;
       
         $service->update(['quantity' => $new_quantite]);
