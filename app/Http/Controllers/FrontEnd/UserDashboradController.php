...
class UserDashboradController extends Controller
{
   ...
   public function cours()
   {
      ...
      $student_courss->each(function ($cours, $has_barcode) {
  
         StudentsCertificateBarcode::where('studentsRegistration_id', $cours->id /* it mean student regisration id*/)->first() == null ? $has_barcode = 0 : $has_barcode = 1;
