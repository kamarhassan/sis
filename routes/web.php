...
Route::group(
    ...
    //    Route::get('/home', [HomeController::class, 'index'])->name('web.home');
       ...
       Route::middleware(['auth', 'verified','emailMustBeVerfied'])->group(function () {
       ...
       Route::middleware(['auth', 'verified', 'emailMustBeVerfied','CheckUserProfileCompleteness'])->group(function () {
